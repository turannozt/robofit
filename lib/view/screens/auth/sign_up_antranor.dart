...
//antranör kayıt
class SignUpPageAntranor extends GetView<SignUpController>
    with DelayHelperMixin {
  SignUpPageAntranor({super.key});
                    ...
                    children: [
                      ...
                      DelayedDisplay(
                        ...
                        child: TitleWithDescription(
                          title: capitalize("${AppTexts.signUp}- Antrenör"),
                          description:
                              "${AppTexts.signUpDescription}Antrenör Kaydı",
                        ),
                      ),
                      DelayedDisplay(
                        delay: getDelayDuration(),
                            ...
                            child: CustomButton(
                              onPressed: () async {
                                controller.createNewAccount(
                                  role: "Antrenor",
                                  name: 'Antrenör ${controller.signUpNameController.text
                                          .trim()}',
